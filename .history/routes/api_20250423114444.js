...
// Status API endpoint - useful for debugging
router.get('/status', (req, res) => {
  ...
  const routeInfo = {
    status: 'online',
    routes: {
      feed: fs.existsSync(path.join(__dirname, './feed.js')),
      glyph: fs.existsSync(path.join(__dirname, './glyph.js')),
      whisper: fs.existsSync(path.join(__dirname, './whisper.js')),
      terminal: true
    },
    views: {
      bleedstream: fs.existsSync(path.join(__dirname, '../views/feed/bleedstream.html')),
      crucible: fs.existsSync(path.join(__dirname, '../views/glyph/crucible.html')),
      whisperboard: fs.existsSync(path.join(__dirname, '../views/whisper/board.html')),
      numbpill: fs.existsSync(path.join(__dirname, '../views/secrets/numbpill.html'))
    },
