...
function init(server) {
  ...
  wss.on('connection', (ws, req) => {
    ...
    // Log number of connected clients and users
    console.log(`Total connected clients: ${clients.size}, total connected users: ${userSockets.size}`);
    ...
    ws.on('message', (message) => {
     try {
       ...
       console.log('WebSocket message size:', message.length, 'bytes'); // Add log
