...
try {
  ...
  try {
    db.exec(`ALTER TABLE districts ADD COLUMN css_theme TEXT;`);
  } catch (e) {
    console.log('Column css_theme already exists');
  }
  
  try {
    db.exec(`ALTER TABLE districts ADD COLUMN theme_color TEXT;`);
  } catch (e) {
    console.log('Column theme_color already exists');
  }
  
  try {
    db.exec(`ALTER TABLE districts ADD COLUMN unlock_puzzle TEXT;`);
  } catch (e) {
    console.log('Column unlock_puzzle already exists');
  }
  
  try {
    db.exec(`ALTER TABLE districts ADD COLUMN has_forum INTEGER DEFAULT 0;`);
  } catch (e) {
    console.log('Column has_forum already exists');
  }
  
  try {
    db.exec(`ALTER TABLE districts ADD COLUMN has_chat INTEGER DEFAULT 0;`);
  } catch (e) {
    console.log('Column has_chat already exists');
  }
  
  try {
    db.exec(`ALTER TABLE districts ADD COLUMN has_minigame INTEGER DEFAULT 0;`);
  } catch (e) {
    console.log('Column has_minigame already exists');
  }
  console.log('Districts table updated');

  // Update profiles table for theme templates
  try {
    db.exec(`ALTER TABLE profiles ADD COLUMN theme_template TEXT DEFAULT 'default';`);
  } catch (e) {
    console.log('Column theme_template already exists');
  }
